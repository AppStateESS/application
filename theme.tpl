...
<html>
  ...
  <head>
    <meta http-equiv="X-UA-Compatible" content="IE=edge" /> {BASE}
    ...
    <script src="https://use.fontawesome.com/f3fe0ac1bd.js"></script>
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css"> {METATAGS} {JAVASCRIPT} {STYLE}
  </head>

  <body class="application">
    {NAV_LINKS}
    <div class="container-fluid">{BODY} {ANALYTICS_END_BODY}</div>
  </body>
